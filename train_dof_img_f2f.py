...
if __name__ == '__main__':
    ...
    dataset_dir = 'infos/training_sets/c95_5cv/f0'
    ...
    now_str = 'dcl2_big_m25_ns2_bi_f1' # directly slice from the volumes, slow
    now_str = 'dcl2_big_m25_ns2_bi_f2' # directly slice from the volumes, slow
    # now_str = 'dcl2_big_m25_ns2_bi_f3' # directly slice from the volumes, slow
    # now_str = 'dcl2_big_m25_ns2_bi_f4' # directly slice from the volumes, slow
    now_str = 'dcl2_big_m25_ns2_bi_f5' # directly slice from the volumes, slow
    # now_str = 'dcl2_big_m25_ns2_bi_f6' # directly slice from the volumes, slow
    # now_str = 'dcl2_big_m25_ns2_bi_f7' # directly slice from the volumes, slow
    # now_str = 'dcl2_big_m25_ns2_bi_f8' # directly slice from the volumes, slow
    # now_str = 'dcl2_big_m25_ns2_bi_f9' # directly slice from the volumes, slow
